...
const gradient = "linear-gradient(108.13deg, rgba(255, 88, 88, 0.5) 0%, rgba(240, 152, 25, 0.5) 100%)";
  ...
  return (
    <div className="bg-[rgba(17,11,35,0.98)] pl-20 pr-32 pt-38 flex items-start justify-between rounded-3xl">
      <div className="max-w-sm">
        <h1 className="text-[#F0F6FF] font-medium text-6xl pb-6">
          Connect with your DJ in real-time
        </h1>
        <p className="text-xl text-[#EDE7FF] font-normal max-w-2xs pb-8">
          Tap in, request bangers, tip DJs, and keep the party lit
        </p>
        <div className="flex w-100 max-w-md gap-5 pb-38">
          <a
            style={{
