...
const gradient = "linear-gradient(108.13deg, rgba(255, 88, 88, 0.5) 0%, rgba(240, 152, 25, 0.5) 100%)";
  ...
  return (
    <div className="md:bg-[rgba(17,11,35,0.98)] pl-5 pr-5 md:pl-24 md:pr-32 md:pt-38 flex items-start justify-between rounded-3xl">
      <div className="md:max-w-sm">
        <h1 className="text-[#F0F6FF] font-medium text-3xl md:text-6xl pb-6">
          Connect with your DJ in real-time
        </h1>
        <p className="text-xl text-[#EDE7FF] font-normal md:max-w-xs pb-8">
